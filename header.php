...
$catdata = $category->getCategoryByStatus();

$product = new Product();
$plist = $product->lists();

if(isset($_GET['msg']) && $_GET['msg']==1) {
	echo $sub_id = $_GET['msg'];
}
		...
		<div class="header-two"><!-- header-two -->
			<div class="container">
				<div class="header-logo">
					<h1><a href="index.php"><span>N</span>aya <i>Bazaar</i></a></h1>
					<h6>Your stores. Your place.</h6> 
				</div>	
				<div class="header-search">
					<form action="search.php" method="post">
						<input type="search" name="search_bar" placeholder="Search for a Product..." required="">
						<button type="submit" class="btn btn-default" aria-label="Left Align" name='search'>
							<i class="fa fa-search" aria-hidden="true"> </i>
						</button>
					</form>
					<?php if(isset($err['search_bar'])){ echo $err['search_bar']; } ?>
				</div>
						...
						<nav class="cd-dropdown"> 
							...
							<ul class="cd-dropdown-content"> 
								...
								<li class="has-children">
									<a href="index.php"><?php echo $cd->name; ?></a>
									<ul class="cd-secondary-dropdown is-hidden"> 
										<li class="go-back"><a href="#">Menu</a></li>
										<li class="see-all"><a href="products2.html"><?php echo $cd->name; ?></a></li>
										<li class="has-children">
											<a href="products2.html"></a> 
											<ul class="is-hidden"> 
												
												<li><a href="products2.html"><?php echo $plist[1]->sub_category; ?></a></li> 
