...
$product = new Product();
$product->id = $id;
$piddata = $product->getProductByID();
			...
			<div class="single-page">
				<div class="single-page-row" id="detail-21">
						...
						<div class="flexslider">
							<ul class="slides">
								<li data-thumb="images/s1.jpg">
									<div class="thumb-image detail_images"> <img src="admin/image/<?php echo $piddata[0]->feature_image; ?>" data-imagezoom="true" class="img-responsive" alt=""> </div>
								</li>
					...
					<div class="col-md-6 single-top-right">
						<h3 class="item_name"><?php echo $piddata[0]->title; ?></h3>
						...
						<div class="single-price">
							<ul>
								<li><?php echo $piddata[0]->price; ?></li>  
								<li><del>$600</del></li> 
						...
						<p class="single-price-text"><?php echo $piddata[0]->short_description; ?></p>
					...
					<div class="panel panel-default">
						...
						<div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
							<div class="panel-body">
								<?php echo $piddata[0]->short_description; ?>
							</div>
						</div>
					</div>
					<div class="panel panel-default">
