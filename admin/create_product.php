<?php
 ...
 if(isset($_POST['save'])){
    ...
    if($_FILES['feature_image']['error']==0){
         if($_FILES['feature_image']['type']=='image/jpeg' || $_FILES['feature_image']['type']=='image/png'){
    ...
    if(isset($_POST['price']) && !empty($_POST['price']) && trim($_POST['price'])){
      ...
      $product->set('created_by',$_SESSION['admin_username']);
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" action='' method='post' enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label>Title</label>
                                            <input name='title' class="form-control"> <?php if(isset($err['title'])){ echo $err['title'];} ?>
                                        
                                        </div>

                                         <div class="form-group">
                                            <label>Short Description</label>
                                            <textarea class="form-control" name='short_description' > </textarea> <?php if(isset($err['short_description'])){ echo $err['short_description'];} ?>
                                        
                                        </div>

                                         <div class="form-group">
                                            <label>Feature Image</label>
                                            <input type='file' name='feature_image' class="form-control">  <?php if(isset($err['feature_image'])){ echo $err['feature_image'];} ?>
                                        
                                        </div>
                                       
                                         <div class="form-group">
                                            <label>Price</label>
                                            <input name='price' class="form-control"> <?php if(isset($err['price'])){ echo $err['price'];} ?>
                                        </div>
                                        ...
                                        <button type="submit" name='save' class="btn btn-info">Save Product</button>
