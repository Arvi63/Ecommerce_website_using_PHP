...
$piddata = $product->getProductByCategoryID();
		...
		<div class="container">
			<div class="col-md-9 product-w3ls-right">
				...
				<div class="products-row">
					<?php foreach($piddata as $pdata) { ?>

					<div class="col-md-3 product-grids"> 
						<div class="agile-products">
							<div class="new-tag"><h6>20%<br>Off</h6></div>
							<a href="single.php?id=<?php echo $pdata->id; ?>"><img src="admin/image/<?php echo $pdata->feature_image; ?>" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
								<h5><a href="single.php?id=<?php echo $pdata->id; ?>"><?php echo $pdata->title; ?></a></h5> 
								<h6><del>$200</del> <?php echo $pdata->price; ?></h6> 
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<a href="single.php"><img src="images/e2.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
					...
					<div class="col-md-3 product-grids"> 
						<div class="agile-products">
							...
							<a href="single.php"><img src="images/e3.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							<div class="new-tag"><h6>New</h6></div>
							<a href="single.php"><img src="images/e4.png" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
								<h5><a href="single.php">Digital Camera</a></h5> 
